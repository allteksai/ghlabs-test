...
<head>
    ...
    <meta name="keywords" content="'pharmaceutical consulting', 'medical device', 'drug manufacturing', 'global pharmaceutical markets'" />
    <meta name="description" content="Global Harvest Pharmaceuticals is a privately held US Corporation providing strategic service for the development, management and manufacturing supply of niche products to the pharmaceutical, medical device, instrument and diagnostic equipment industries." />
   
<title>Global Harvest Pharma</title>

<link href="favicon.ico" rel="shortcut icon" type="image/x-icon" />
<link href="ghl.css" rel="stylesheet" type="text/css" />
...
<script type="text/javascript">
  ...
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-20578243-1']);
...
<body onload="MM_preloadImages('images/btn_home_over.png','images/btn_about_over.png','images/btn_service_over.png','images/btn_drugnews_over.png','images/btn_fda_over.png','images/btn_contact_over.png','images/btn_success_over.png','images/btn_newswire_over.png')";initLightbox()>
<div class="wrapper">
<div id="headerGHPtext"><a href="index.htm"><img src="images/header/GHL_header_text_01.png" width="268" height="18" border="0" /></a></div>
<div id="addressBlock">121 Stryker Lane, Building 30, Suite 2<br />
Hillsborough, NJ 08844</div>
<div id="logo"><a href="index.htm"><img src="images/header/logo_ghl.png" width="120" height="38" border="0" /></a></div>
<div id="WhatWhoWhy"> <a href="services.htm" class="www">WHAT WE DO</a>&nbsp; |&nbsp; <a href="aboutus.htm" class="www">WHO WE ARE</a> &nbsp;| &nbsp;<a href="contact.htm" class="www">CONTACT US</a></div>
<table class="ghp" border="0" cellspacing="0" cellpadding="0" align="center">
<tr>
    <td colspan="3" bgcolor="#F8F8F8"><img src="images/spacer.gif" width="1" height="2" />
    <td>
</tr>
<tr>
...
myimages[1]="images/header/header_01_div.jpg"
myimages[2]="images/header/header_02_div.jpg"
myimages[3]="images/header/header_03_div.jpg"
myimages[4]="images/header/header_04_div.jpg"
myimages[5]="images/header/header_05_div.jpg"


var ry=Math.floor(Math.random()*myimages.length)
if (ry==0)
ry=1
document.write('<img src="'+myimages[ry]+'" border=0 width=980 height=229')
}
random_imglink()
//-->
</script></td>
  ...
  <tr>
    <td colspan="3" align="center"><img src="images/spacer.gif" width="1" height="1" /></td>
  </tr>
    <td class="leftcol"><a href="index.htm" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image2','','images/btn_home_over.png',1)"><img src="images/btn_home_normal.png" name="Image2" width="176" height="29" vspace="2" border="0" id="Image2" /></a><br />
          <a href="aboutus.htm" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image3','','images/btn_about_over.png',1)"><img src="images/btn_about_normal.png" name="Image3" width="176" height="29" vspace="2" border="0" id="Image3" /></a><br />
          <a href="services.htm" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image4','','images/btn_service_over.png',1)"><img src="images/btn_service_normal.png" name="Image4" width="176" height="29" vspace="2" border="0" id="Image4" /></a><br />
  <a href="newswire.htm" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image17','','images/btn_newswire_over.png',1)"><img src="images/btn_newswire_normal.png" name="Image17" width="176" height="29" vspace="2" border="0" id="Image17" /></a><br />
          <a href="contact.htm" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image7','','images/btn_contact_over.png',1)"><img src="images/btn_contact_normal.png" name="Image7" width="176" height="29" vspace="2" border="0" id="Image7" /></a><br />  
<br />
<form method="GET" action="searchresults.php">

        <input name="zoom_query" type="text" value="Search" size="15">
    ...
    <td class="maincontent" width="555">      <div class="maincontent_pad">        
          <p><?php
// ----------------------------------------------------------------------------
...
{
	// Insert the form
	$OutputBuffers[$OUTPUT_FORM_SEARCHBOX] = $STR_FORM_SEARCHFOR . " <input type=\"text\" name=\"zoom_query\" size=\"20\" value=\"".htmlspecialchars($query)."\" id=\"zoom_searchbox\" class=\"zoom_searchbox\" />\n";
	...
	if ($FormFormat == 2)
	{
		...
		$OutputBuffers[$OUTPUT_FORM_RESULTSPERPAGE] .= "</select><br /><br /></span>\n";
		if ($UseCats)
		{
			...
			for ($fieldnum = 0; $fieldnum < $NumMetaFields; $fieldnum++)
			{
				...
				else if ($metafields[$fieldnum][$METAFIELD_TYPE] == $METAFIELD_TYPE_DROPDOWN)
				{
					...
					foreach ($metafields[$fieldnum][$METAFIELD_DROPDOWN] as $ddv)
					{
						...
						if ($ddi == floatval($meta_query[$fieldnum]))
		...
		$OutputBuffers[$OUTPUT_FORM_MATCH] .= "<br /><br /></span>\n";
	}
	else
	{
...
if (empty($query))
{
	...
	if ($NoSearch)
	{
		...
		if ($ZoomInfo == 1)
			$OutputBuffers[$OUTPUT_PAGENUMBERS] .= "<center><p><small>" . $STR_POWEREDBY . " <a href=\"http://www.wrensoft.com/zoom/\" target=\"_blank\"><b>Zoom Search Engine</b></a></small></p></center>";
...
if ($Recommended == 1)
{
	...
	while (!feof($fp_rec))
	{
		...
		if (strlen($recline) > 0)
		{
			$sep = strrpos($recchAsSubstring == 0)
					$pattern = $pattern . "\Z";
...
$OutputBuffers[$OUTPUT_HEADING] .= "<br /><br /></div>\n";
...
?>
    ...
    <td class="rghtcol"> <table width="231" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td class="submenutop"><img src="images/spacer.gif" width="6" height="15" /></td>
        </tr>
        <tr>
          <td class="submenucontent"><!-- #BeginLibraryItem "/Library/companyMenu.lbi" -->&nbsp;<img src="images/icon_arrow_45.png" width="13" height="14" align="absmiddle" /><span class="h2cheat">&nbsp;&nbsp;COMPANY</span>
        <p class="p_subMenu">
          <img src="images/icon_arrow_small.png" width="15" height="12" align="absmiddle" />
      &nbsp;<a href="aboutus.htm">Who We are</a><br />
<br />
<!--
<img src="../images/icon_arrow_small.png" width="15" height="12" align="absmiddle" />
...
//-->
<img src="images/icon_arrow_small.png" width="15" height="12" align="absmiddle" />
      &nbsp;<a href="careers.htm">Careers</a><br />
      &nbsp;
        <!-- #EndLibraryItem --></td>
        </tr>
        <tr>
          <td class="submenubottom"><img src="images/spacer.gif" width="10" height="18" /></td>
        </tr>
      </table></td>
  </tr> 
  <!-- Begin MSIE Hack - Important: Don't remove this following row.  Hack because Microsoft still cannot make a proper web browser. -->
  <tr>
    <td><img src="images/spacer.gif" width="185" height="1" /></td>
    <td class="bottomcap"><img src="images/spacer.gif" width="555" height="40" /></td>
    <td><img src="images/spacer.gif" width="235" height="1" /> </td>
  </tr><!-- End MSIE Hack -->
  <tr>
    <td colspan="3" class="footerline"><img src="images/spacer.gif" width="1" height="6"/></td>
  </tr>
  <tr>
    <td colspan="3" align="center" style="color: #0066CC; font-size:10px;"> 
Copyright &copy; 2011 Global Harvest Laboratories<br /></td>
  </tr>
  </table>
    <div align="center" ><img src="images/bg_bottom_cap_01.png" /></div>
</div>
</body>
</html>
